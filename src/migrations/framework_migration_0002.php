...
class Framework_Migration_0002 {
	...
	static function install() {
		...
		");
		$db->execSQL("INSERT INTO `users` (`id`, `name`, `surname`, `email`, `language`, `password`, `role`, `registerTime`, `flags`) VALUES (1, 'admin', 'admin', 'admin@admin.com', 'en', '".\Users::password_hash('Admin@123')."', 'admin', ".time().", ".(\Users::FLAGS_NEED_CHANGE_PASSWORD).");");
	}
